...
def get_H2O_mols( poscar, threshold = 1.2, to_print = "True" ):
	system = read( poscar )
...
def get_NH4_mols( poscar, threshold = 1.2, to_print = "True" ):
	system = read( poscar )
...
def get_CH3NH3_mols( poscar, threshold = 1.2, to_print = "True" ):
	system = read( poscar )
	nitrogen_indices = [ i for i, j in enumerate(system) if j.symbol == "N" ]
	hydrogen_indices = [ i for i, j in enumerate(system) if j.symbol == "H" ]
...
def get_H2O_within_surface_threshold( poscar, H2O_mols, distance_threshold = 2.6, to_print = "True" ):
	system = read( poscar )
...
def get_NH4_within_surface_threshold( poscar, NH4_mols, distance_threshold = 5.6, to_print = "True" ):
	system = read( poscar )
	au_indices = [ i for i, atom in enumerate(system) if atom.symbol == "Au" ]
	au_positions = system.positions[ au_indices ]
...
def get_CH3NH3_within_surface_threshold( poscar, CH3NH3_mols, distance_threshold = 3.6, to_print = "True" ):
	system = read( poscar )
	au_indices = [ i for i, atom in enumerate(system) if atom.symbol == "Au" ]
	au_positions = system.positions[ au_indices ]
...
def get_closest_H2O_to_electrode( poscar, H2O_close_to_electrode, to_print = "True" ):
	system = read( poscar )
	au_indices = [ i for i, atom in enumerate(system) if atom.symbol == "Au" ]
...
def get_H2O_near_electrode_from_Na_hydration_shell( poscar, H2O_close_to_electrode, distance_threshold = 2.6, to_print = "True" ):
	system = read( poscar )
	au_indices = [ i for i, atom in enumerate(system) if atom.symbol == "Au" ]
	na_indices = [ i for i, atom in enumerate(system) if atom.symbol == "Na" ]
	au_positions = system.positions[ au_indices ]
...
def get_H2O_near_electrode_NOT_from_Na_hydration_shell( poscar, H2O_close_to_electrode, distance_threshold = 3.6, to_print = "True" ):
	system = read( poscar )
	au_indices = [ i for i, atom in enumerate( system ) if atom.symbol == "Au" ]
	na_indices = [ i for i, atom in enumerate( system ) if atom.symbol == "Na" ]
	au_positions = system.positions[ au_indices ]
...
def get_NH4_closest_to_electrode( poscar, NH4_mols, to_print = "True" ):
	system = read( poscar )
	au_indices = [ i for i, atom in enumerate( system ) if atom.symbol == "Au" ]
...
def get_H2O_close_to_NH4( psocar, H2O_close_to_electrode, NH4_mols, threshold = 2.5, to_print = "True" ):
	system = read( poscar )
	results = []
...
def get_H2O_close_to_surface_and_NH4( poscar, H2O_close_to_electrode, NH4_mols, max_distance_to_Au = 4.5, max_distance_O_to_H_of_NH4 = 3.8, to_print = "True" ):
	system = read( poscar )
	Au_indices = [ i for i, atom in enumerate( system ) if atom.symbol == "Au" ]
	results = list()
...
def get_CH3NH3_closest_to_electrode( poscar, CH3NH3_mols, to_print = "True" ):
	system = read( poscar )
	au_indices = [ i for i, atom in enumerate( system ) if atom.symbol == "Au" ]
...
def get_H2O_close_to_surface_and_CH3NH3( poscar, H2O_close_to_electrode, CH3NH3_mols, max_distance_to_Au = 5.5, max_distance_of_H_of_NH3_group_of_CH3NH3_to_O_of_H2O = 4, to_print = "True" ):
	system = read( poscar )
	Au_indices = [ i for i, atom in enumerate(system) if atom.symbol == "Au" ]
	results = list()
...
def get_H2O_close_to_CH3NH3( system, H2O_close_to_electrode, CH3NH3_mols, threshold = 2.5, to_print = "True" ):
	system = read( system )
	results = list()
	for h2o in H2O_close_to_electrode:
		h1_idx, o_idx, h2_idx = h2o
...
if __name__ == "__main__":
	...
	get_CH3NH3_within_surface_threshold( "POSCAR", CH3NH3_mols )
